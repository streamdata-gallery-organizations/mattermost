...
x-complete: 0
info:
  title: Mattermost API Purge all Elasticsearch indexes
  description: |-
  ...
  /ldap/sync:
    post:
      ...
      description: |-
        ...
        ##### Permissions
        Must have `manage_system` permission.
      operationId: synchronize-any-user-attribute-changes-in-the-configured-adldap-server-with-mattermost-permissionsmu
      x-api-path-slug: ldapsync-post
      responses:
        200:
          description: OK
      tags:
  ...
  /elasticsearch/purge_indexes:
    post:
      ...
      description: |-
        ...
        ##### Permissions
        Must have `manage_system` permission.
      operationId: deletes-all-elasticsearch-indexes-and-their-contents-after-calling-this-endpoint-it-isnecessary-to-s
      x-api-path-slug: elasticsearchpurge-indexes-post
      responses:
        200:
          description: OK
      tags:
